...
def get_str_for_file_name(model):
    """
    Convert huggingface model names to names used for saving in files.
    :param model:
    :return:
    """
...
def substitute_generation_including_noise_removal_excluding_original_unmasked(data, substitutes_df, lm_tokenizer,
    ...
    :param data:
    :param substitutes_df:
    :param lm_tokenizer:
    :param fill_mask:
    :param model_name_str:
    :return:
    """
...
def substitute_selection_phase_2_option_3(data, substitutes_df, lm_tokenizer, fill_mask, model_name_str, nlp,
    ...
    print(
        f"SS_phase2_option3a_BS{score_model_name_str}_{model_name_str} exported to csv in path "
        f"'./predictions/SS_phase2_option3{letter}_BS{score_model_name_str}_{model_name_str}.tsv'\n")
